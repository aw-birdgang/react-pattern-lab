...
import DataProcessor from '../../components/after/DataProcessor';
...
const TransitionExample: React.FC = () => {
  ...
  return (
    <div style={{ padding: '20px' }}>
      <h2>전환 패턴 예제 (최적화 후)</h2>
      <p>데이터 처리를 시작하고 카운터를 증가시켜보세요. UI가 블로킹되지 않습니다.</p>
      ...
      <div style={{ 
        ...
        <div style={{ padding: '20px', backgroundColor: '#f8f9fa', borderRadius: '8px' }}>
          ...
          <div style={{ marginTop: '20px', padding: '15px', backgroundColor: '#d4edda', borderRadius: '4px' }}>
            <h4>개선점:</h4>
            <ul>
              <li>useTransition으로 데이터 처리가 백그라운드에서 실행됨</li>
              <li>UI가 블로킹되지 않아 다른 인터랙션이 가능함</li>
              <li>isPending 상태로 처리 중임을 알 수 있음</li>
              <li>사용자 경험이 크게 개선됨</li>
            </ul>
          </div>
